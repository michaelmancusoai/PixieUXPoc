...
const PatientImaging: React.FC<PatientImagingProps> = ({ patient }) => {
      ...
      {selectedImage ? (
        ...
        <Card sx={{ width: '100%' }}>
          <CardHeader 
            ...
            action={
              <Box sx={{ display: 'flex', gap: 1 }}>
                <Button variant="outlined" size="small" startIcon={<ZoomIn style={{ height: 16, width: 16 }} />}>
                  Zoom
                </Button>
                <Button variant="outlined" size="small" startIcon={<RotateCw style={{ height: 16, width: 16 }} />}>
                  Rotate
                </Button>
                <Button variant="outlined" size="small" onClick={handleCloseImage} startIcon={<Grid3X3 style={{ height: 16, width: 16 }} />}>
                  Gallery
                </Button>
              </Box>
            }
          ...
          <CardContent sx={{ pt: 3 }}>
            ...
            <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mt: 3 }}>
              ...
              <Box sx={{ display: 'flex', gap: 1 }}>
                <Button variant="outlined" size="small" startIcon={<Download style={{ height: 16, width: 16 }} />}>
                  Download
                </Button>
                <Button variant="outlined" size="small" startIcon={<Share2 style={{ height: 16, width: 16 }} />}>
                  Share
                </Button>
              </Box>
            </Box>
        ...
        <Box>
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
            ...
            <Box sx={{ display: 'flex', gap: 1 }}>
              <Button variant="outlined" size="small" startIcon={<Search style={{ height: 16, width: 16 }} />}>
                Search
              </Button>
              <Button variant="contained" size="small" color="primary" startIcon={<Plus style={{ height: 16, width: 16 }} />}>
                Add Images
              </Button>
            </Box>
          </Box>
              ...
              {tabValue === index && (
                <Box sx={{ py: 1 }}>
                  ...
                  {mockImages.filter(img => img.category === category.id).length === 0 && (
                    ...
                    >
                      <FileImage style={{ width: 48, height: 48, margin: '0 auto', color: 'rgba(0,0,0,0.3)' }} />
                      ...
                      <Button 
                        variant="contained" 
                        size="small" 
                        startIcon={<Plus style={{ height: 16, width: 16 }} />}
                      >
                        Add Images
                      </Button>
                    </Paper>
