...
export class MemStorage implements IStorage {
  ...
  async getAppointmentsByDate(date: string): Promise<Appointment[]> {
    // For demo purposes, always return appointments on the specified date
    // ignoring timezone issues as this is a demo
    console.log(`Looking for appointments on date: ${date}`);
    
    // Always return all appointments for the demo - they're all on the same day
  ...
  private initializeSampleData() {
    ...
    providerData.forEach(provider => {
      ...
      const created: Provider = { 
        ...provider, 
        id: this.providerId++,
        color: provider.color || null // Make sure color is never undefined
      };
    ...
    operatoryData.forEach(operatory => {
      ...
      const created: Operatory = { 
        ...operatory, 
        id: this.operatoryId++,
        color: operatory.color || null // Make sure color is never undefined
      };
    ...
    patientData.forEach(patient => {
      ...
      const created: Patient = { 
        ...
        id: this.patientId++,
        dateOfBirth: null,
        avatarInitials: patient.avatarInitials || null,
    ...
    // Set today to be April 23, 2025 (month is 0-indexed, so April is 3)
    const today = new Date(2025, 3, 23); 
    
    // All appointments use today's date as the appointment date
    const appointmentData: Partial<Appointment>[] = [
      // Op 1 Appointments
      { 
        patientId: 1, providerId: 1, operatoryId: 1, 
        date: new Date(today), startTime: "09:00:00", duration: 70, 
      ...
      { 
        ...
        date: new Date(today), startTime: "11:00:00", duration: 60, 
      ...
      { 
        ...
        date: new Date(today), startTime: "13:00:00", duration: 45, 
        cdtCode: "D0120", status: AppointmentStatus.SCHEDULED
      },
      { 
        patientId: 7, providerId: 1, operatoryId: 1, 
        date: new Date(today), startTime: "15:00:00", duration: 60, 
      ...
      { 
        ...
        date: new Date(today), startTime: "08:30:00", duration: 60, 
        cdtCode: "D2393", status: AppointmentStatus.SCHEDULED
      },
      { 
        patientId: 2, providerId: 2, operatoryId: 2, 
        date: new Date(today), startTime: "10:00:00", duration: 90, 
      ...
      { 
        ...
        date: new Date(today), startTime: "08:00:00", duration: 120, 
      ...
      { 
        ...
        date: new Date(today), startTime: "11:30:00", duration: 45, 
        cdtCode: "D0120", status: AppointmentStatus.SCHEDULED
      },
      { 
        patientId: 12, providerId: 3, operatoryId: 3, 
        date: new Date(today), startTime: "14:30:00", duration: 60, 
      ...
      { 
        ...
        date: new Date(today), startTime: "09:30:00", duration: 90, 
        cdtCode: "D2330", status: AppointmentStatus.SCHEDULED
      },
      { 
        patientId: 3, providerId: 4, operatoryId: 4, 
        date: new Date(today), startTime: "12:00:00", duration: 75, 
      ...
      { 
        ...
        date: new Date(today), startTime: "14:00:00", duration: 60, 
      ...
      { 
        ...
        date: new Date(today), startTime: "16:00:00", duration: 90, 
    ...
    appointmentData.forEach(appointment => {
      // Parse string dates to actual Date objects
      let dateObj: Date;
      if (typeof appointment.date === 'string') {
        dateObj = parse(appointment.date, 'yyyy-MM-dd', new Date());
      } else {
        dateObj = appointment.date || new Date();
      }
      ...
      const created: Appointment = {
        ...
        seatedAt: appointment.seatedAt || null,
        preClinicalAt: appointment.preClinicalAt || null,
        doctorReadyAt: appointment.doctorReadyAt || null,
        chairStartedAt: appointment.chairStartedAt || null,
        wrapUpAt: appointment.wrapUpAt || null,
        readyCheckoutAt: appointment.readyCheckoutAt || null,
    ...
    waitlistData.forEach(entry => {
      ...
      const created: Waitlist = { 
        ...entry, 
        id: this.waitlistId++,
        requestedProcedure: entry.requestedProcedure || null,
        propensityScore: entry.propensityScore || null,
        notes: entry.notes || null,
        requestDate: entry.requestDate || new Date()
      };
